...
const NavBar = ({ children }) => {
    const link = "https://drive.google.com/file/d/1h619MccLpjVHzKiwlW1vkqedvstKv9HI/view?usp=sharing"
        ...
        <div className=''>
            <div class="drawer" data-theme={dark ? "dark" : "cupcake"}>
                ...
                <div class="drawer-content flex flex-col">
                    <div class="w-full navbar bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded shadow-lg ">
                        <div className='navbar-start'>
                            ...
                            <div><Link to='/' class=" text-lg lg:text-2xl lg:ml-20 text-primary font-bold font-serif shadow">SHAKIBA ALAM</Link></div>
                        </div>
                        <div class="navbar-center hidden lg:block">
                            <ul class="menu menu-horizontal p-0 text-white text-lg font-semibold">
                                <li>
                                    <NavLink to='/' >
                                        Home
                                    </NavLink>
                                ...
                                <li>
                                    <NavLink to='/about' className='rounded'>
                                        About me
                                    </NavLink>
                                </li>
                                <li>
                        ...
                        <div class="navbar-end lg:mr-32">
                            <a href={link} target="_blank" rel="noopener noreferrer" class="btn btn-secondary text-white">Download Resume <BsFillArrowDownCircleFill className='ml-2' /></a>
                        </div>
                    </div>
                    {children}
                </div>
