                ...
                <div class="drawer-content flex flex-col">
                    <div class="w-full navbar bg-base-100">
                        <div className='navbar-start'>
                            ...
                            <div><Link to='/' class="btn btn-ghost  text-xl lg:ml-32">PORTFOLIO</Link></div>
                        </div>
                        <div class="navbar-center hidden lg:block">
                            <ul class="menu menu-horizontal p-0">
                                ...
                                <li>
                                    <NavLink to='/project' className='rounded'>
                                        Project
                                    </NavLink>
                                </li>
                        ...
                        <div class="navbar-end lg:mr-32">
                            <a href={link} target="_blank" rel="noopener noreferrer" class="btn">Download Resume <BsFillArrowDownCircleFill className='ml-2' /></a>
                        </div>
                    </div>
                    {children}
                </div>
